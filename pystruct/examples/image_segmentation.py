...
data_train = cPickle.load(open("/home/mschiegg/data/VOC/data_train.pickle"))
C = 0.01
...
ssvm = learners.NSlackSSVM(
    model, verbose=1, C=C, max_iter=1, n_jobs=-1,
    tol=0.0001, show_loss_every=1,
    logger=SaveLogger(experiment_name + ".pickle", save_every=100),
    inactive_threshold=1e-3, inactive_window=10, batch_size=100)
ssvm.fit(data_train['X'], data_train['Y'])

data_val = cPickle.load(open("/home/mschiegg/data/VOC/data_val.pickle"))
